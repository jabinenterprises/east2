                ...
                >
                    ...
                    <ul className="space-y-3 text-primary-foreground/70 md:space-y-6">
                        <li className="flex gap-4">
                            {/* <i className="bi bi-diagram-3 text-2xl text-green-700"></i> */}
                            <div>
                        ...
                        <li className="flex gap-4">
                            {/* <i className="bi bi-fullscreen-exit text-2xl text-green-700"></i> */}
                            <div>
                                <h5 className="text-lg font-semibold">
                                    Proven Success
                                </h5>
                        ...
                        <li className="flex gap-4">
                            {/* <i className="bi bi-broadcast text-2xl text-green-700"></i> */}
                            <div>
                                <h5 className="text-lg font-semibold">
                                    Sustainable Impact
                                </h5>
                    ...
                    <div>
                        ...
                        {/* <a
                            href="#"
                            className="inline-block rounded-md bg-green-700 px-6 py-3 font-medium text-white transition hover:bg-green-800"
                        >
                            See More
                        </a> */}
                    </div>
